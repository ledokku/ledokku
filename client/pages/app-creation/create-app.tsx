...
const SourceBox = ({
  ...
  return (
    <div
      className={`w-full p-12 flex flex-col border-2 items-center rounded-lg  ${onClick ? 'grayscale-0 opacity-100 cursor-pointer' : 'grayscale  opacity-50'}`}
      onClick={onClick}
      style={
        {
              ...
              >
                <Grid md={3} xs={6}>
                  <SourceBox
                    ...
                    onClick={() => formik.setFieldValue('type', AppTypes.GITHUB)}
                  />
                </Grid>
                <Grid md={3} xs={6}>
                  <SourceBox
