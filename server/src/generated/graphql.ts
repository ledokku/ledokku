...
> = {
  ...
  databases?: Resolver<
    Maybe<Array<ResolversTypes['Database']>>,
    ParentType,
    ContextType
  >;
...
> = {
  servers?: Resolver<
    Maybe<Array<ResolversTypes['Server']>>,
    ParentType,
    ContextType
  >;
  server?: Resolver<
...
> = {
  ...
  >;
  saveDigitalOceanAccessToken?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<
      MutationSaveDigitalOceanAccessTokenArgs,
      'digitalOceanAccessToken'
    >
  >;
  createDigitalOceanServer?: Resolver<
    ResolversTypes['Server'],
    ParentType,
    ContextType,
    RequireFields<MutationCreateDigitalOceanServerArgs, 'serverName'>
  >;
  createApp?: Resolver<
    ResolversTypes['App'],
    ParentType,
  ...
  createDatabase?: Resolver<
    ResolversTypes['Database'],
    ParentType,
    ContextType,
    RequireFields<MutationCreateDatabaseArgs, 'input'>
  >;
  updateServerInfo?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateServerInfoArgs, 'serverId'>
  >;
};
